...
postgres=# CREATE TABLE peer_state_vrf(device_ip VARCHAR(40) NOT NULL, peer_ip VARCHAR(20) NOT NULL, state VARCHAR(5) NOT NULL, vrf_name VARCHAR(5) NOT NULL, primary key(device_ip, peer_ip, vrf_name));
...
postgres=# CREATE TABLE kafka2(id  SERIAL NOT NULL, device_ip  VARCHAR(50)  NOT NULL, peer_ip  VARCHAR(50)  NOT NULL, peer_as  VARCHAR(50)  NOT NULL, nexthub  VARCHAR(50)   NOT NULL, prefix  VARCHAR(50)   NOT NULL, comm  VARCHAR(500)  NOT NULL, vrf_name  VARCHAR(50)  NOT NULL, primary key(peer_ip, peer_as, nexthub, PREFIX, comm, vrf_name)
);
